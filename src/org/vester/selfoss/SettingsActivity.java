...
public class SettingsActivity extends PreferenceActivity {
	...
	static final String URL_DEFAULT = "https://";

	static final String BACKUP_URL = "backup_url";

	public static final String TYPE = "type";
	public static final String TYPE_DEFAULT = "";
	static final String TYPE_UNREAD = "type=unread";
	static final String TYPE_STARRED = "type=starred";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setupActionBar();
		// addPreferencesFromResource(R.xml.pref_selfoss);
	}
	...
	private void setupSimplePreferencesScreen() {
		...
		// Add 'selfoss' preferences.
		// PreferenceCategory fakeHeader = new PreferenceCategory(this);
		// fakeHeader.setTitle(R.string.pref_header_selfoss);
		...
		bindPreferenceSummaryToValue(findPreference(BACKUP_URL));
	...
	private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
		...
		public boolean onPreferenceChange(Preference preference, Object value) {
			...
			if (preference instanceof ListPreference) {
				...
				preference.setSummary(password.toString());
			} else {
	...
	@TargetApi(Build.VERSION_CODES.HONEYCOMB)
	public static class SelfossPreferenceFragment extends PreferenceFragment {
		@Override
